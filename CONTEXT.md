...
only through `src/shared-tokens.css`, the closed set of opaque type, shape and
hue both surfaces read (#441, #456, #545) — and is not the light or dark theme
the operating system supplies. v1
