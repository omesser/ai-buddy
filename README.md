...
| **Timber Wolf** | BattleTech OmniMech (Sketchfab model by MekaRamen, permitted derivative). | Patrol mech. Desktop is a sector to secure, reports are brief. Clan warriors don't waste words. [full prompt](./characters/timber-wolf/personality.txt) |
