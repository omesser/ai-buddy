...
/// Opened on first call and reused for the process lifetime. `None` if
/// connect fails or `DISPLAY` is unset. Failure is cached: X11 will not
/// appear later, and handles will be Wayland or unavailable.
