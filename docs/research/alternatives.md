...
| Capability | ai-buddy | Desktop Mate | VPet | Shimeji-ee | Desktop Pet | OpenPets | MateEngine |
|---|---|---|---|---|---|---|---|
| Harness integrations (ACP Completer) | ✅ (claude/hermes/opencode/pi/grok named+verified; codex named unverified; + custom) | ❌ | ❌ | ❌ | ❌ | ✅ | ❌ |
...
(#433 2026-09-07, named claude/hermes/opencode/pi/grok rows + custom ACP command
per #556 2026-09-08; pi verified #628 2026-09-11; grok verified #587 2026-09-09; codex unverified). Each Instance has its own Director and
...
1. **Personality-driven AI behavior (shipped).** Authored `personality.txt` (who
   ...
   named claude/hermes/opencode/pi/grok rows + custom ACP command per #556
   2026-09-08; pi verified #628 2026-09-11; grok verified #587 2026-09-09; codex unverified). No other desktop pet ships authored personality
