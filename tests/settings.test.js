...
// Live snapshot.view.instances is InstanceRow objects, not the newline
// string the fixtures hand-write. An object in a text node is [object Object]
// (#892). Name (character) is what the list has to print.
